                ...
                <form onSubmit={handleSubmit} style={{ padding: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '2rem', paddingTop: '1.5rem', borderTop: '1px solid #e2e8f0' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem' }}>
                            ...
                            <button type="submit" disabled={loading} style={{ padding: '0.8rem 2rem', background: '#2563eb', color: 'white', borderRadius: '6px', border: 'none', cursor: 'pointer', fontWeight: 'bold', boxShadow: '0 4px 6px -1px rgba(37, 99, 235, 0.2)' }}>
